...
Array.prototype.at = function (index) {
  requireArgs('at', [index]);
  typeCheckArgs('at', arguments, ['number']);
  genericErrorCheck(index < 0 - this.length || index > this.length - 1, 'at', `Cannot get element at index "${index}" from an array with length of ${this.length}`);
